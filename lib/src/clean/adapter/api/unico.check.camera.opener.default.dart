...
class UnicoCheckCameraOpenerDefault extends UnicoCheckCameraOpener
  ...
  UnicoCheckCameraOpenerDefault({required OpenCameraUseCase openCameraUseCase,
  ...
  void buildDefaultRequest(String jsonFileName) {
    ...
    _openCameraRequest.setUnicoConfig(_unicoTheme);
    _openCameraRequest.setTimeoutSession(_timeoutSession);
  }

  @override
  void openCameraDocument({required String jsonFileName,
